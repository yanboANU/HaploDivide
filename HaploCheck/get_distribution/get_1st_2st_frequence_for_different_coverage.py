...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        print ("python " + sys.argv[0] + " mutation_record *column which_block")
        sys.exit()
    ...
    ignoreLen = 10000
    real_snpPosition, real_snpContent = read.read_snp2(sys.argv[1], start+ignoreLen, end-ignoreLen, base) # mutation_record
